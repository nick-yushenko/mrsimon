...
public class UpdateStudyGroupRequest : IValidatableObject
{
    ...
    [Required(ErrorMessage = "Дата начала группы обязательна.")]
    public DateOnly? StartsOn { get; set; }

    // Дата всегда передается явно, сервер не вычисляет окончание учебного года автоматически.
    [Required(ErrorMessage = "Дата окончания группы обязательна.")]
