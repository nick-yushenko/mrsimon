...
//   dropdown: "0 0 2px 0 rgba(145, 158, 171, 0.24), 0 20px 40px -4px rgba(145, 158, 171, 0.24)",
//   dialog: "0 24px 48px 0 rgba(145, 158, 171, 0.24)",
// };

// shared/theme/custom-shadows.ts
